...
print("SN.PY ------------------------------------ 444444444444444444444444")
...
client = mqtt.Client("rpi_client1_sn4") #this should be a unique name
flag_connected = 0
...
def MQTT_Revice_Test(client, userdata, msg):
    ...
    print("MQTT_Revice_Test(cvilux_all) ------------------------------------ 444444444444444444444444 ", cvilux_all)
...
def callback_esp32_1_temp(client, userdata, msg):
    ...
    print("ESP_temp1 4444444444444 =====================================================>>>>> ", ESP_temp1)
