...
def callback_esp32_2_temp_warn(client_sn2, userdata, msg):
    global warning_over
    global warning_clear

    temp_warn_2 = msg.payload.decode('utf-8')
    
    if(temp_warn_2 == "over"):
        warning_over = warning_over + 1
        print("warning_over  ++++++++++++++++++++++++++++++++++++>> ", warning_over)
        display_tjc("Warning","b2.txt")

    # if(temp_warn_2 == "clear"):
    #     warning_clear = warning_clear + 1
    #     print("warning_clear  -------------------------------------->> ", warning_clear)

client_sn2.message_callback_add('warn/2/#', callback_esp32_2_temp_warn)
