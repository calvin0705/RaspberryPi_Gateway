...
print("SN.PY ------------------------------------ 66666666666666666666666")
...
client = mqtt.Client("rpi_client1_sn6") #this should be a unique name
flag_connected = 0
...
def MQTT_Revice_Test(client, userdata, msg):
    ...
    print("MQTT_Revice_Test(cvilux_all) ------------------------------------ 66666666666666666666 ", cvilux_all)
